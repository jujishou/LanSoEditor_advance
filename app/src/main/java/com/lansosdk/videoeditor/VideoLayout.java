...
public class VideoLayout extends VideoEditor {
    ...
    public int executeLayout2Video(int outW, int outH,
        ...
        String filter = String.format(Locale.getDefault(),
                "nullsrc=size=%dx%d [base];" +
                        ...
                        "[base][v0] overlay=x=%d:y=%d [tmp1]; " +
                        "[tmp1][v2] overlay=x=%d:y=%d", outW, outH, v1X, v1Y, v2X, v2Y);
    ...
    public int executeLayout3Video(int outW, int outH,
        ...
        String filter = String.format(Locale.getDefault(),
                "nullsrc=size=%dx%d [base];" +
                        ...
                        "[base][v0] overlay=x=%d:y=%d [tmp1]; " +
                        "[tmp1][v1] overlay=x=%d:y=%d [tmp2]; " +
                        "[tmp2][v2] overlay=x=%d:y=%d", outW, outH, v1X, v1Y, v2X, v2Y,v3X,v3Y);
    ...
    public int executeLayout4Video(int outW, int outH,
        ...
        String filter = String.format(Locale.getDefault(),
                "nullsrc=size=%dx%d [base];" +
                        ...
                        "[base][v0] overlay=x=%d:y=%d [tmp1]; " +
                        "[tmp1][v1] overlay=x=%d:y=%d [tmp2]; " +
                        "[tmp2][v2] overlay=x=%d:y=%d [tmp3]; " +
                        "[tmp3][v3] overlay=x=%d:y=%d", outW, outH, v1X, v1Y, v2X, v2Y,v3X,v3Y,v4X,v4Y);
    ...
    public int executeLayout5Video(int outW, int outH,
        ...
        String filter = String.format(Locale.getDefault(),
                "nullsrc=size=%dx%d [base];" +
                        ...
                        "[tmp1][v1] overlay=x=%d:y=%d [tmp2]; " +
                        "[tmp2][v2] overlay=x=%d:y=%d [tmp3]; " +
                        "[tmp3][v3] overlay=x=%d:y=%d [tmp4]; " +
                        "[tmp4][v4] overlay=x=%d:y=%d", outW, outH, v1X, v1Y, v2X, v2Y,v3X,v3Y,v4X,v4Y,v5X,v5Y);
    ...
    public int executeLayout6Video(int outW, int outH,
        ...
        String filter = String.format(Locale.getDefault(),
                "nullsrc=size=%dx%d [base];" +
                        ...
                        "[tmp2][v2] overlay=x=%d:y=%d [tmp3]; " +
                        "[tmp3][v3] overlay=x=%d:y=%d [tmp4]; " +
                        "[tmp4][v4] overlay=x=%d:y=%d [tmp5]; " +
                        "[tmp5][v5] overlay=x=%d:y=%d", outW, outH, v1X, v1Y, v2X, v2Y,v3X,v3Y,v4X,v4Y,v5X,v5Y,v6X,v6Y);
    ...
    public static void test() {
        ...
        layout.executeLayoutScale2Video(720,720,p1,p2,"/sdcard/dd32.mp4");
