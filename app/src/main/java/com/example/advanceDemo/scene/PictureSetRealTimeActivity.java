...
public class PictureSetRealTimeActivity extends Activity {
                ...
                .setOnDrawPadThreadProgressListener(new onDrawPadThreadProgressListener() {
                    ...
                    public void onThreadProgress(DrawPad arg0, long arg1) {
                        if (arg1 >= 1000 * 1000 && isSwitched == false) {
                            bgLayer.switchBitmap(BitmapFactory
                                    .decodeFile("/sdcard/a2.jpg"));
                            isSwitched = true;
                        }
                    }
                });
    ...
    private void startDrawPad() {
        ...
        if (drawPadView.startDrawPad()) {
            String picPath = CopyFileFromAssets.copyAssets(mContext, "pic720x720.jpg");

            // 先 增加第一张Bitmap的Layer, 因为是第一张,放在DrawPad中维护的数组的最下面, 认为是背景图片.
            bgLayer = drawPadView.addBitmapLayer(BitmapFactory
                    .decodeFile(picPath));
    ...
    private void addMVLayer() {
        String colorMVPath = CopyDefaultVideoAsyncTask.copyFile(
                PictureSetRealTimeActivity.this, "mei.mp4");
        String maskMVPath = CopyDefaultVideoAsyncTask.copyFile(
                PictureSetRealTimeActivity.this, "mei_b.mp4");
    ...
    private void addBitmapLayer(int resId, long startMS, long endMS) {
        Layer item = drawPadView.addBitmapLayer(BitmapFactory.decodeResource(
                getResources(), resId));
        ...
        MoveAnimation move1 = new MoveAnimation(startMS * 1000,
                total * 1000 / 3, 0, item.getPadHeight() / 2, /* 开始位置, 结束位置 */
                ...
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (SDKFileUtils.fileExist(dstPath)) {
                            ...
                            Toast.makeText(PictureSetRealTimeActivity.this,
