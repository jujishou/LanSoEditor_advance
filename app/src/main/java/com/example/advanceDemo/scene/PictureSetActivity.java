...
public class PictureSetActivity extends Activity {
    private static final String TAG = "PictureSetActivity";
    ...
    private void initDrawPad() {
        ...
        drawPadView.setRealEncodeEnable(width, height, 1000000, (int) 30, dstPath);
        ...
        drawPadView.setOnViewAvailable(new onViewAvailable() {
            ...
            public void viewAvailable(DrawPadView v) {
                ...
                Log.i(TAG,"LSTODO ---------onview available");
    ...
    private void addMVLayer() {
        ...
        String maskMVPath = CopyDefaultVideoAsyncTask.copyFile(
                PictureSetActivity.this, "mei_b.mp4");
        ...
        findViewById(R.id.id_DrawPad_saveplay).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (SDKFileUtils.fileExist(dstPath)) {
                    Intent intent = new Intent(PictureSetActivity.this, VideoPlayerActivity.class);
                    intent.putExtra("videopath", dstPath);
                    startActivity(intent);
                } else {
                    Toast.makeText(PictureSetActivity.this,
