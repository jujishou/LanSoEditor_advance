...
public class VideoPlaySeekDemoActivity extends Activity {

    protected static final String TAG = "VideoPlaySeekDemoActivity";
    String mVideoPath;
    MediaInfo mInfo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editVideoMode = new EditModeVideo(getApplication(), mVideoPath);
    ...
    private void initView() {
        ...
        findViewById(R.id.id_videoseek_back).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                VideoPlaySeekDemoActivity.this.finish();
            }
        });
        ...
        seekBar.setOnSeekChangeListener(new IndicatorSeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(IndicatorSeekBar seekBar, int progress, float progressFloat, boolean
                ...
                if (fromUserTouch) {
                    ...
                    //seek时间;
                    long seekMs = (long) ((progress / 100f) * mInfo.vDuration * 1000);
...
//				Toast.makeText(VideoPlaySeekDemoActivity.this, "视频播放完毕!",Toast.LENGTH_SHORT).show();
            }
        });
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if(bitmaps!=null && bitmaps.size()>0){
                ...
                for (int i = 0; i < bitmaps.size(); i++) {
                    ImageView imageView = new ImageView(VideoPlaySeekDemoActivity.this);
