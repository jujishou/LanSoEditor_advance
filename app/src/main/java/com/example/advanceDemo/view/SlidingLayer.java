/*
 * 此代码不属于lansosdk的一部分, 来源自网络. 
 *   <com.example.advanceDemo.view.SlidingLayer
        android:id="@+id/id_effect_slideinlayer"
        android:layout_width="match_parent"
        android:layout_alignParentBottom="true"
        android:layout_height="250dip">
         <include 
             layout="@layout/slide_bianhuan_layout"/>
    </com.example.advanceDemo.view.SlidingLayer>	
    
     slidelayerEffect=(SlidingLayer)findViewById(R.id.id_effect_slideinlayer);
        slidelayerEffect.setStickTo(SlidingLayer.STICK_TO_BOTTOM);
		   slidelayerEffect.setCloseOnTapEnabled(false);
		   slidelayerEffect.setShadowWidth(0);
		   slidelayerEffect.setShadowDrawable(null);
		   
		   findViewById(R.id.id_drawpad_testopen).setOnClickListener(new OnClickListener() {
		   ...
		   findViewById(R.id.id_slide_bianhuan_close).setOnClickListener(new OnClickListener() {
