###蓝松短视频编辑SDK, 专业版 android端演示工程.  和其他短视频SDK的最大区别: 我们可能是唯一一家提供 图层架构的SDK, 所有的操作,都是一层一层的完成的. 每个图层都支持移动 缩放 旋转 滤镜,亮暗,隐藏,等属性; 您可以任意个性化. 比如常见的美颜, 滤镜,文字,涂鸦,MV,增加各种动画, 抖音效果, 趣推效果;

###SDK,支持AE模板,你可以直接把设计师做好的视频动画工程,输入到我们SDK中,从而直接实现各种个性化的视频效果.
